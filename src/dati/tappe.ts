...
export const TAPPE: Tappa[] = [
  ...
  },
  {
    ...
    tipo: 'bacaro',
    coordinate: [12.32778, 45.43949],
    raggio: 20,
    distanzaDallaPrecedente: 70,
    descrizione:
      'Vecchia bottega diventata osteria con divani, libri e concerti la sera, sul rio accanto a campo San Giacomo dall’Orio. È la sosta dove ci si siede davvero.',
    ordinazioni: [
